...
import {getUSD} from '../services/currencies';
...
export default function Screen()
{
    ...
    const USD = conversion
    const BRL = currentValue
    let valueExchange;
    if(BRL > 0){
        valueExchange = BRL * parseInt(USD);
    }else{
        valueExchange =0;
    }
    ...
    return (
        <View style={styles.boxCurrency}>
            ...
            <Image source={require('../assets/usd.png')} style={styles.img}/>
            <View style={styles.boxCurrency}>
          
            <Text style={styles.textValue}> 1 USD = R${currentValue} </Text>
            </View>
            <Pressable onPress={updateCurrency}>
                <Text style={styles.textBtn}>Update Currency</Text>
            </Pressable>
            <Text style={styles.titleConversion}>Convert USD to REAL</Text>
